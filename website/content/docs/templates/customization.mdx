...
For backward compatibility, Ralph also checks these older locations:

```
~/.config/ralph-tui/
├── prompt.md                # Legacy: JSON tracker
└── prompt-beads.md          # Legacy: Beads trackers
```

These are checked after the new `templates/` folder structure.
