...
<Steps>
  ...
  <Step title="Legacy Templates">
    For backward compatibility, Ralph also checks the older format:
    - `~/.config/ralph-tui/prompt.md` for JSON tracker
    - `~/.config/ralph-tui/prompt-beads.md` for Beads trackers
  </Step>
