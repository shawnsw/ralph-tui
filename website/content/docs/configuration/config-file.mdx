...
# Auto-commit: when true, ralph-tui stages and commits all changes after each
# successful task completion. When false, no automatic commit is made (agents
...
Use [Claude Code Router](https://github.com/anthropics/ccr) to route requests through alternative providers like OpenRouter, DeepSeek, Ollama, or Gemini:
