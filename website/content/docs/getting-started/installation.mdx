...
**Global (personal)** - Available across all projects:
...
**Local (project)** - Takes precedence, version-controllable:
...
<Callout type="tip">
Local skills take precedence over global skills, allowing project-specific customizations that can be version-controlled with your project.
</Callout>
...
# Install skills to global directory (default)
ralph-tui skills install

# Install skills to local project directory
ralph-tui skills install --local
