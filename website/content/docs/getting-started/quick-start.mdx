---
title: Quick Start
description: Get up and running with Ralph TUI in 5 minutes using JSON mode - no external dependencies required.
---
...
- **Header**: Current iteration and active task
...
- **[Best Practices](/docs/guides/best-practices)** - Tips for effective autonomous coding
