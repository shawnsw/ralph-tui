...
When ending a work session, use the `/land-the-plane` skill for a complete checklist.

**Quick version:** Commit, push, and provide hand-off context. Work is NOT complete until `git push` succeeds.
